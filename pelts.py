...
class TwoColour(object):
    ...
    white_patches = ['ANY', 'TUXEDO', 'LITTLE', 'VAN', 'ANY', 'TUXEDO', 'LITTLE', 'VAN',
                     'ANYCREAMY', 'TUXEDOCREAMY', 'LITTLECREAMY', 'VANCREAMY']
...
class Speckled(object):
    ...
    white_patches = ['ANY', 'TUXEDO', 'LITTLE', 'ANY', 'TUXEDO', 'LITTLE',
                     'ANYCREAMY', 'TUXEDOCREAMY', 'LITTLECREAMY']
...
class Tortie(object):
    ...
    white_patches = ['TUXEDO', 'LITTLE', 'TUXEDO', 'LITTLE',
...
class Calico(object):
    ...
    white_patches = ['ANY', 'TUXEDO', 'VAN', 'ANY', 'TUXEDO', 'VAN',
                     'ANYCREAMY', 'TUXEDOCREAMY', 'VANCREAMY']
...
pelt_c_no_bw = ['PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'PALEGINGER', 'GOLDEN', 'GINGER',
                'DARKGINGER', 'LIGHTBROWN', 'BROWN', 'DARKBROWN']
tortie_pattern = ['ONE', 'TWO', 'FADEDONE', 'FADEDTWO']
calico_pattern = ['ONE', 'TWO', 'THREE', 'FOUR', 'FADEDONE', 'FADEDTWO', 'FADEDTHREE', 'FADEDFOUR']
